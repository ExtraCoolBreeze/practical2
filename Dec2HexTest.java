...
public class Dec2HexTest {
    ...
    public void testExceptionalNegative() {
        Dec2Hex.decimalToHexadecimal(-1);  // This should throw IllegalArgumentException for negative input
    }

    @Test(expected = IllegalArgumentException.class)
    public void testExceptionalInvalidInput() {
        Dec2Hex.main(new String[]{});  // This should throw IllegalArgumentException for no input argument
    }
